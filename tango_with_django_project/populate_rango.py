...
def populate():
    python_pages = [
        ...
        {'title':'How to Think like a Computer Scientist', 'url':'http://www.greenteapress.com/thinkpython/', 'views':55},
        {'title':'Learn Python in 10 Minutes', 'url':'http://www.korokithakis.net/tutorials/python/', 'views':45} ]
    ...
    other_pages = [
        ...
        {'title':'Flask', 'url':'http://flask.pocoo.org', 'views':35} ]
